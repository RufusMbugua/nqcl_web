...
<div class="message_container">
    ...
    <div class="msg_body">
            ...
            <form  action="admin.php?action=cms_changes" method="post">
            
                            CONTENT NAME: &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" class="text" 
                            style= "width:450px; height:23px; margin-top:10px; color:#00a460; font-size:14px;" 
                             name="data_type" readonly="readonly" value="<?php echo $saga_x['news_x']->data_type ?>" />
                            <br /><br />
                            
                            <textarea class="ckedior" id="workspace" name="data_body">
                                <?php
                                    echo $saga_x['news_x']->data_body
                                ?>
                            </textarea>
                            <input type="hidden" name="ID" value="<?php echo $saga_x['news_x']->ID ?>" />
