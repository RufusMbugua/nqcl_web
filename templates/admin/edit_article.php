...
<div class="a">
	<div class="inner_a">
    	<a href="admin.php?action=messages"><div class="close"></div></a>
...
<div class="message_container">
	<div class="a1">make appropriate changes in the displayed data<font style="color:#00a460;"></font></div>
    
    <div class="msg_body">
    
    		<form  action="admin.php?action=article_changes" method="post">
            
                            ARTICLE HEADING: &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" class="text" 
                            style= "width:450px; height:23px; margin-top:10px; color:#00a460; font-size:14px;" 
                             name="news_head" required="required" value="<?php echo $saga['news']->news_head ?>" />
                            <br /><br />
                            
                            <textarea class="ckedior" id="workspace" name="news_body">
                                <?php
                                    echo $saga['news']->news_body
                                ?>
                            </textarea>
                            <input type="hidden" name="ID" value="<?php echo $saga['news']->ID ?>" />
